...
python main.py -n $N -i 2 -m $M -t 1 -M purpose -f single_line -a no+info --txt=6-1 --lamuta=0.06 --graph=${GRAPH_PATH} --data=${DATA_PATH} --alpha=${alpha} --kind=2 --list=${LIST_PATH} --same=0

python draw_figures.py ${DATA_PATH} 3
